...
class post(db.Model):
    """
    Class to represent the postList model
    """
    __tablename__ = 'posts'
    ...
    items = db.relationship('postItem', backref='item', lazy='dynamic')
    ...
    def json(self):
        """
        Json representation of the post model.
        :return:
        """
        return {
            'id': self.id,
...
class postItem(db.Model):
    ...
    def __init__(self, name, description, post_id):
        self.name = name
